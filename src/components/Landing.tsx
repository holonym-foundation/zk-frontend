    ...
    <>
      <div style={outerContainer}>
        <div style={innerContainer}>
          ...
          >
            <p>Holonym is a privacy tool to verify your identity with minimal leakage of information. Your government ID and phone number are never linked to your address. Data is deleted from third party servers after you complete verification. Your data is encrypted with your wallet key and can only be read by you.</p>
          </div>
