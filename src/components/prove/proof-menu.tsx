    ...
    <RoundedWindow>
      {!account?.address ? (
        ...
        <div className="x-wrapper small-center" style={{ width: "100%" }}>
          ...
          <h6>
            Be one of the first people to mint the privacy-preserving soulbound
            NFTs that show only a particular attribute about yourself, without
            revealing who you are. For a larger anonymity set, you may choose to
          ...
          <p>
            <i>
              If you're here for Gitcoin Passport, choose "Unique Personhood
              (Government) ID" to boost your unique humanity score
            </i>
          </p>
          ...
          <button
            onClick={() => navigate("/prove/uniqueness")}
            className="glowy-green-button"
          >
            Mint Unique Personhood (government ID)
          </button>
          <div className="spacer-large" />
          <button
            onClick={() => navigate("/prove/uniqueness-phone")}
            className="glowy-green-button"
          >
            Mint Unique Personhood (phone number)
          </button>
          <div className="spacer-large" />
          <button
            onClick={() => navigate("/prove/us-residency")}
            className="glowy-green-button"
          >
            Mint US Residency
          </button>
